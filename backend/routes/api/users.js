// These routes handle users as well as clients
...
router.post("/:userId/clients", async (req, res, next) => {
...
router.get("/:userId/clients/:clientId", async (req, res, next) => {
  const userId = req.params.userId;
...
router.put("/:userId/clients/:clientId", async (req, res, next) => {
  const userId = req.params.userId;
  const clientId = req.params.clientId;
  const { firstName, email } = req.body;
...
router.delete("/:userId/clients/:clientId", async (req, res, next) => {
  const userId = req.params.userId;
  const clientId = req.params.clientId;
